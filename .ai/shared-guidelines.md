...
- **Clickable paths in the terminal** — a link provider over filesystem paths, checked main-side against the panel's own guards; see [contexts/terminal-path-links.md](contexts/terminal-path-links.md)
